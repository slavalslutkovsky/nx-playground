...
export function TasksListPage() {
  ...
  const [filter, setFilter] = createSignal<'all' | 'todo' | 'in_progress' | 'done'>('all');
    ...
    <div class="container mx-auto p-4 max-w-6xl">
      ...
      >
        <Show
          ...
          fallback={<div class="text-center py-8 text-gray-500">No tasks found</div>}
        >
          <div class="space-y-4">
                  ...
                  <div class="flex justify-between items-start">
                    <div class="flex-1">
                      <h3 class="text-xl font-semibold">
                        <Link to={`/tasks/${task.id}`} class="hover:text-blue-500">
                          {task.title}
                        </Link>
                      </h3>
